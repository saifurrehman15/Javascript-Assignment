...
// document.write("<h1> The Table of 5 </h1>")
// var table = 5 * 1;
...
// var opt = prompt("Plus Minus Divide Multiply");
...
//     document.write(num1 / num2)
// }else{
//     document.write("Value is not assigned")
// }
...
//     alert("The character code of " + userInput + " is " + "" + charCode);
// } else {
...
// document.write("<h1>factorial of " + promptmy + " " + " is <br> </h1>" )

// for(var i = promptmy - 1 ; i >= 0;--i){
//     document.write(promptmy + " x " + i + " =" + promptmy * i + "<br>");
// }
...
// }
// //count vowels
// var prr =prompt("Enter Alphabets");

// for(var i =1;i<=prr.length;i++){
//     if(prr.length === "a" && prr.length === "e" &&prr.length ===  "i" && prr.length === "o" &&prr.length ===  "u"){
//         document.write(i)
//     }
// }


// var cars = ['Mehran','Bmw','Cultus','Audi','Suzuki'];

// var userInp =prompt("Enter your Cars");

// var up22= userInp.slice(0,1).toUpperCase();
// var up23= userInp.slice(1).toLowerCase();
// var joi = up22 + up23;
// var inn = cars.indexOf(joi);


// for(var i = 0; i<=cars.length ; i++){
// if(joi === cars[i]){
//     document.write(cars[i] + "Found on" + " " + inn);
//     break
// }
// }
